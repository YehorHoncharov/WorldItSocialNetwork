...
export default function FriendsProfile() {
    ...
    const friend: IUser = {
        ...
        date_of_birth:
            typeof params.dateOfBirth === "string" ? new Date(params.dateOfBirth) : undefined,
        ...
        friendship_from:
            typeof params.friendshipFrom === "string" ? JSON.parse(params.friendshipFrom) : [],
        friendship_to:
            typeof params.friendshipTo === "string" ? JSON.parse(params.friendshipTo) : [],
    };
    return (
        <Providers>
