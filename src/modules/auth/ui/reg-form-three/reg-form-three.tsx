        ...
        <>
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={{ alignItems: "center" }}>
                        <Text style={{ fontWeight: "500", textAlign: "center" }}>
                            ...
                            <Text style={{ fontWeight: "700" }}>({params.email})</Text>. Введіть
                ...
                <View style={{ marginTop: 24 }}>
                    <Text style={{ fontWeight: 400, marginBottom: 8 }}>Код підтвердження</Text>
                    <CodeField
                        ref={ref}
                        {...props}
                        value={code}
                ...
                <View style={{ gap: 16, alignItems: "center" }}>
                    ...
                    <TouchableOpacity onPress={onBack}>
                        <Text style={{ fontWeight: "500", color: "#543C52" }}>Назад</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <RegStepTwoModal
